        ...
        <div className="p-6 border-b border-slate-200/50 dark:border-slate-700/30">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className="text-xl font-medium text-foreground tracking-tight">Secure Chat</h2>
          ...
          <div className="space-y-8 max-w-4xl mx-auto">
            {messages.length === 0 ? (
              <div className="text-center py-20">
                ...
                <h3 className="text-3xl font-bold text-foreground tracking-tight mb-4 bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">Welcome to Secure Chat</h3>
